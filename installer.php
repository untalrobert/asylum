...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'prueba_9eaf1a17690477817184_20231228203024_archive.zip';
        const ARCHIVE_SIZE       = '43674656';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '9eaf1a1-28203024';
        const SECONDARY_PACKAGE_HASH = '98828d0-28203024';
